...
class TeacherController extends Controller
{
	...
	public function show($id)
	{
		...
		return view('teacher.show', compact('students', 'subject'));
	}
	...
	public function showGrade($subjId, $userId)
	{
		...
		return view('teacher.grades.show', compact('student', 'subject', 'grades'));
	}
	...
	public function createGrade($subjId, $userId)
	{
		...
		return view('teacher.grades.create', compact('student', 'subject'));
	}
	...
	public function editGrade($subjId, $gradeId)
	{
		...
		return view('teacher.grades.edit', compact('subject', 'grade', 'student'));
	}
	...
	public function edit($id)
	{
		...
		return view('teacher.edit', compact('subject'));
	}
